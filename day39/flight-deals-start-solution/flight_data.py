...
class FlightData:
    def __init__(self, price, origin_airport, destination_airport, out_date, return_date, stops=0) -> None:
        """
...
def find_cheapest_flight(data): # type: ignore
    ...
    cheapest_flight = FlightData(lowest_price, origin, destination,out_date,return_date, stops=number_of_stops)
